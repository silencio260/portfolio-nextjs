...
const Footer = () => {
  return (
    <div className='w-full  mb-[100px] md:mb-5' id='contact'>
        ...
        <div className='flex flex-col items-center'>
            ...
            <div className='flex mt-16 md:flex-row flex-col justify-between'>
                <p className='md:text-base text-sm md:font-norma; font-light'>
                    Copyright © 2024 Faruq Shabi
                    ...
                    <div className='flex items-center md:gap-3 gap-6'>
                        {socialMedia.map((profile) => (
                            ...
                            saturate-180 bg-opacity-75 bg-black-200 rounded-lg border
                             border-black boreder border-black-300`}>
                                <img 
                                    src={profile.img} 
                                    alt={'profile'}
                                    width={20} 
